...
def main():
	...
	# os.system("mv "+os.path.join(CUR_DIR,lib_dir,out_dir,"rlbenchmark.txt") +" "+ out_dir)
	#os.system("rm "+serial_thread_state)
	print ""	
	# tr.result('Resume_time',resume_time,'msecs')
	tr.result('Resume_time',kernel_time,'msecs')
	# tr.add_attachment(os.path.join(CUR_DIR,out_dir,'raw_data.txt'))
	tr.add_attachment(os.path.join(CUR_DIR,out_dir,'dmesg.txt'))
	tr.add_attachment(os.path.join(CUR_DIR,out_dir,'outttylog.txt'))
	# tr.add_attachment(os.path.join(CUR_DIR,out_dir,'abl_dump.txt'))
	# tr.add_attachment(os.path.join(CUR_DIR,lib_dir,out_dir,'rlbenchmark.txt'))
	tr.save()
